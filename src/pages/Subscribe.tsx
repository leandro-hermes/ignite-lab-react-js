      ...
      <div className="w-full max-w-[1100px] flex items-center justify-between mt-20 mx-auto">
        <div className="max-w-[640px]">
          ...
          <h1 className="mt-8 text-[2.5rem] leading-tight">
            Construa uma <strong className="text-blue-500">aplicação completa</strong>, do zero, com <strong
            className="text-blue-500">React</strong>
          </h1>
        ...
        <div className="p-8 bg-gray-700 border rounded border-gray-500">
          <strong className="text-2xl text-2xl block mb-6">
